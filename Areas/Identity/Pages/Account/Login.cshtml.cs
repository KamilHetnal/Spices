        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    List<ShoppingCard> lsdShoppingCard =
                        await _db.ShoppingCard.Where(u => u.ApplicationUserId == user.Id).ToListAsync();

                    HttpContext.Session.SetInt32(SD.ssCardCount, lsdShoppingCard.Count);
